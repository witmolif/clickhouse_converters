Файлы форматов XLSX и XLS приводятся в "нужный" формат для заливки в clickhouse - меняются переводы строк, кодировки файлов, заменяются пустые ячейки на 0 или " ", своеобразные даты Excel - 43320 в YYYY-MM-DD
